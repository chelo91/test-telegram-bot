...
bot.hears("wall", (ctx) => controller.redditAmoledbackgrounds(ctx));
*/
/*bot.hears("puntos", (ctx) => controller.redditAmoledbackgrounds(ctx))
bot.hears("tabla", (ctx) => controller.redditAmoledbackgrounds(ctx))
*/
